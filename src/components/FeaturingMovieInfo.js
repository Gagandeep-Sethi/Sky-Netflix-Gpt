  ...
  return (
    <div className='w-screen aspect-video bg-gradient-to-tr from-black  text-white absolute '>
       <div className=' pt-[20%] pl-[8%]'>
        ...
        <div>
            <button className='py-4 px-6 rounded-lg mr-4 bg-gray-400 mt-4 hover:bg-opacity-70'>▶️  Play</button>
            <button className='py-4 px-6 rounded-lg mr-4 bg-gray-400 mt-4 hover:bg-opacity-70'>
